...
var totalScore = 0;
var hc = document.getElementById("highscore");
hc.innerText = "Highest Score: " + highestScore;
...
function hitTest(tween) {
    ...
    if (intersection.segment1 && intersection.segment2) {
        ...
        sc.innerText = +sc.innerText + hitcount;

        if (+highestScore < +sc.innerText) {
            localStorage.setItem("highestScore", sc.innerText);
            hc.innerText = "Highest Score: " + sc.innerText;
        }
